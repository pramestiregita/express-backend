...
router.post('/product/color', upload.array('picture'), productController.createColor) // add product
...
router.put('/product/color/:id', upload.array('picture'), productController.updateColorProduct) // edit product
