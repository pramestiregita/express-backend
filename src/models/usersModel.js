...
const join = 'INNER JOIN user_details ON user_details.user_id=users.id INNER JOIN roles ON roles.id=users.role_id INNER JOIN gender ON gender.id=user_details.gender_id'
