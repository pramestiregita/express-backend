...
const column = `${table}.id, ${table}.transaction_id, ${tableStore}.name AS store, ${table}.product_name, ${table}.price, ${table}.quantity, ${table}.total_price, ${table}.delivery_fee, ${table}.summary, ${table}.created_at`
